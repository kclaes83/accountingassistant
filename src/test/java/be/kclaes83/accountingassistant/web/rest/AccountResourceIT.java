...
import be.kclaes83.accountingassistant.config.Constants;
import be.kclaes83.accountingassistant.domain.PersistentToken;
import be.kclaes83.accountingassistant.domain.User;
import be.kclaes83.accountingassistant.repository.AuthorityRepository;
import be.kclaes83.accountingassistant.repository.PersistentTokenRepository;
import be.kclaes83.accountingassistant.repository.UserRepository;
import be.kclaes83.accountingassistant.security.AuthoritiesConstants;
import be.kclaes83.accountingassistant.service.UserService;
import be.kclaes83.accountingassistant.service.dto.AdminUserDTO;
import be.kclaes83.accountingassistant.service.dto.PasswordChangeDTO;
import be.kclaes83.accountingassistant.web.rest.vm.KeyAndPasswordVM;
import be.kclaes83.accountingassistant.web.rest.vm.ManagedUserVM;
