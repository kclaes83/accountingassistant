...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'f9dfe7b4-d181-4dff-a721-b69b04ea6861' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('f1636a8c-a42b-4ffd-bc2b-29883a9ab6fc');
      cy.get(`[data-cy="name"]`).should('have.value', 'f1636a8c-a42b-4ffd-bc2b-29883a9ab6fc');
