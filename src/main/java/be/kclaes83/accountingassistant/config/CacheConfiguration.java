...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, be.kclaes83.accountingassistant.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, be.kclaes83.accountingassistant.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, be.kclaes83.accountingassistant.domain.User.class.getName());
            createCache(cm, be.kclaes83.accountingassistant.domain.Authority.class.getName());
